...
$fileName = "24-Ensure default setting for intra-VM TPS is correct.txt"
...
$commandOutput1 = write-Output "24-Ensure default setting for intra-VM TPS is correct"
$commandOutput2 = Get-VMHost | Get-AdvancedSetting -Name Mem.ShareForceSalting
