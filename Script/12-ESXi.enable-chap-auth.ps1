...
$fileName = "11-ESXi.enable-chap-auth.txt"
...
$commandOutput1 = write-Output "11-ESXi.enable-chap-auth"
$commandOutput2 = Get-VMHost | Get-VMHostHba | Where {$_.Type -eq "Iscsi"} | Select VMHost, Device, ChapType, @{N="CHAPName";E={$_.AuthenticationProperties.ChapName}}
