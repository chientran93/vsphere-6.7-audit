...
$fileName = "21-Establish a password policy for password complexity.txt"
...
$commandOutput1 = write-Output "21-Establish a password policy for password complexity"
$commandOutput2 = Get-VMHost | Get-AdvancedSetting -Name Security.PasswordQualityControl
