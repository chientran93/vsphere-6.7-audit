...
$fileName = "51-Audit use of dvfilter network APIs.txt"
...
$commandOutput1 = write-Output "51-Audit use of dvfilter network APIs"
$commandOutput2 = Get-VMHost | Get-AdvancedSetting -Name Net.DVFilterBindIpAddress
