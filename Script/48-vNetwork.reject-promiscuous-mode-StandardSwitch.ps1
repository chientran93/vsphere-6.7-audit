...
$fileName = "48-vNetwork.reject-promiscuous-mode-StandardSwitch.txt"
...
$commandOutput1 = write-Output "48-vNetwork.reject-promiscuous-mode-StandardSwitch"
$commandOutput2 = Get-VirtualSwitch | Get-SecurityPolicy | Select VirtualSwitch, AllowPromiscuous
