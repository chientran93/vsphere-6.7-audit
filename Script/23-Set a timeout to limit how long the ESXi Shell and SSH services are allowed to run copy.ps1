...
$fileName = "23-Set a timeout to limit how long the ESXi Shell and SSH services are allowed to run.txt"
...
$commandOutput1 = write-Output "23-Set a timeout to limit how long the ESXi Shell and SSH services are allowed to run"
$commandOutput2 = Get-VMHost | Get-AdvancedSetting -Name UserVars.ESXiShellTimeOut
