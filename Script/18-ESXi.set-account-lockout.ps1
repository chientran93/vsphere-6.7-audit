...
$fileName = "18-ESXi.set-account-lockout.txt"
...
$commandOutput1 = write-Output "18-ESXi.set-account-lockout"
$commandOutput2 = Get-VMHost | Get-AdvancedSetting -Name Security.AccountLockFailures
