...
$fileName = "29-VM.disable-disk-shrinking-wiper.txt"
...
$commandOutput1 = write-Output "29-VM.disable-disk-shrinking-wiper"
$commandOutput2 = Get-VM | Get-AdvancedSetting -Name "isolation.tools.diskWiper.disable" | where {$_.value -eq "False"} | Select Entity, Name, Value
