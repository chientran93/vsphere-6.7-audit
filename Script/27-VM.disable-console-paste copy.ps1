...
$fileName = "27-VM.disable-console-paste.txt"
...
$commandOutput1 = write-Output "27-VM.disable-console-paste"
$commandOutput2 = Get-VM | Get-AdvancedSetting -Name "isolation.tools.paste.disable" | where {$_.value -eq "False"} | Select Entity, Name, Value
