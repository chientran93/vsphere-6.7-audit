...
$fileName = "40-Audit all uses of PCI or PCIe passthrough functionality.txt"
...
$commandOutput1 = write-Output "40-Audit all uses of PCI or PCIe passthrough functionality"
$commandOutput2 = Get-VM | Get-AdvancedSetting -Name "pciPassthru*.present" | Select Entity, Name, Value
