...
$fileName = "14-Configure remote logging for ESXi hosts .txt"
...
$commandOutput1 = write-Output "14-Configure remote logging for ESXi hosts "
$commandOutput2 = Get-VMHost | Get-AdvancedSetting -Name Syslog.global.logHost
