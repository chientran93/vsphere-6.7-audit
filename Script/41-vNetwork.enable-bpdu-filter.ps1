...
$fileName = "41-vNetwork.enable-bpdu-filter.txt"
...
$commandOutput1 = write-Output "41-vNetwork.enable-bpdu-filter"
$commandOutput2 = Get-VMHost | Get-AdvancedSetting -Name Net.BlockGuestBPDU
