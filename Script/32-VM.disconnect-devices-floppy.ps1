...
$fileName = "32-VM.disconnect-devices-floppy.txt"
...
$commandOutput1 = write-Output "32-VM.disconnect-devices-floppy"
$commandOutput2 = Get-VM | Get-FloppyDrive | Select Parent, Name, ConnectionState
