...
$fileName = "50-Restrict port-level configuration overrides on VDS.txt"
...
$commandOutput1 = write-Output "50-Restrict port-level configuration overrides on VDS"
$commandOutput2 = Get-VDPortgroup | Get-VDPortgroupOverridePolicy
