...
$fileName = "36-Control access to VM console via VNC protocol.txt"
...
$commandOutput1 = write-Output "36-Control access to VM console via VNC protocol"
$commandOutput2 = Get-VM | Get-AdvancedSetting -Name "RemoteDisplay.vnc.enabled" | where {$_.Value -eq "True"} |  Select Entity, Name, Value
