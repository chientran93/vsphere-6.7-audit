...
$fileName = "19-Set DCUI.Access to allow trusted users to override lockdown mode.txt"
...
$commandOutput1 = write-Output "19-Set DCUI.Access to allow trusted users to override lockdown mode"
$commandOutput2 = Get-VMHost | Get-AdvancedSetting -Name DCUI.Access
