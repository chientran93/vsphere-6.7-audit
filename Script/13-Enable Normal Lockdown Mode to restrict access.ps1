...
$fileName = "13-Enable Normal Lockdown Mode to restrict access.txt"
...
$commandOutput1 = write-Output "13-Enable Normal Lockdown Mode to restrict access"
$commandOutput2 = Get-VMHost | Select Name,@{N="Lockdown";E={$_.Extensiondata.Config.adminDisabled}}
