...
$fileName = "10-Use Active Directory for local user authentication.txt"
...
$commandOutput1 = write-Output "10-Use Active Directory for local user authentication"
$commandOutput2 = Get-VMHost | Get-VMHostAuthentication | Select VmHost, Domain, DomainMembershipStatus
