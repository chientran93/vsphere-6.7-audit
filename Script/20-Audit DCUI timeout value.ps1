...
$fileName = "20-Audit DCUI timeout value.txt"
...
$commandOutput1 = write-Output "20-Audit DCUI timeout value"
$commandOutput2 = Get-VMHost | Get-AdvancedSetting -Name UserVars.DcuiTimeOut
