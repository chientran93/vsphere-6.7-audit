...
$fileName = "37-Do not send host information to guests.txt"
...
$commandOutput1 = write-Output "37-Do not send host information to guests"
$commandOutput2 = Get-VM | Get-AdvancedSetting -Name  "tools.guestlib.enableHostInfo"| where {$_.Value -eq "True"} | Select Entity, Name, Value
