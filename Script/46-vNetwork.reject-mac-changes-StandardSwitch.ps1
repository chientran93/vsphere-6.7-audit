...
$fileName = "46-vNetwork.reject-mac-changes-StandardSwitch.txt"
...
$commandOutput1 = write-Output "46-vNetwork.reject-mac-changes-StandardSwitch"
$commandOutput2 = Get-VirtualSwitch | Get-SecurityPolicy | Select VirtualSwitch, MacChanges
$commandOutput3 = Get-VirtualPortGroup | Get-SecurityPolicy | select VirtualPortGroup, MacChanges
